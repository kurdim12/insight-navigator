...
export const websiteApi = {
  ...
  create: (data: { url: string }) => api.post<Website>('/api/v1/websites', data),
  update: (id: string, data: { url: string }) => api.put<Website>(`/api/v1/websites/${id}`, data),
  delete: (id: string) => api.delete<{ message: string }>(`/api/v1/websites/${id}`),
...
export const scanApi = {
  ...
  getPages: (id: string) => api.get<any[]>(`/api/v1/crawls/${id}/pages`),
};
